...
class Raqueta:
    ...
    file_imagenes = {
        ...
        "drcha": ["electric00d.png", "electric01d.png", "electric02d.png"]
    }
    ...
    def __init__(self, center_x, center_y, w=120, h=20, color=(255, 255, 0)):
        ...
        #para cambiar imagenes (hacer animacion)
        self.direccion = 'izqda'
        self.imagen_activa = 0
        #para cambiar la velocidad de la animacion
        self.cambio_cada_x_fotogramas = 20
    ...
    def __cargar_imagenes(self):
        ...
        for lado in self.file_imagenes:
            ...
            for nombre_fichero in self.file_imagenes[lado]:
                foto = pg.image.load(f"/Users/estelafugaz/Desktop/Programación/Pong_/Imagen/{nombre_fichero}")
